...
Pour rappel, ce programme est écrit avec le langage \verb|C| et j'utilise la librairie \verb|FLINT|.
...
De plus, c'est une récursivité à $\dfrac{n-2}{2}, \dfrac{n-1}{2},\dfrac{n}{2},\dfrac{n+1}{2}$ et $\dfrac{n+2}{2}$ (pour $k=2n$ ou $k=2n+1$).
